...
"it": dict(
 ...
 promo="Le tue share Unraid nell’app File, ovunque, senza VPN.",
...
"fr": dict(
 ...
 promo="Vos partages Unraid dans l’app Fichiers, partout, sans VPN.",
...
"zh-Hans": dict(
 ...
 promo="随时随地在“文件”应用中访问你的 Unraid 共享，无需 VPN。",
